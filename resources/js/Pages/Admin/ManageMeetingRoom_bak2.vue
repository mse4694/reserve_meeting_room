    ...
    <div class="card">
        ...
        <div class="ml-4 mr-4">
            ...
            <Dialog v-model:visible="meetingRoomDialog" :style="{width: '450px'}" header="ข้อมูลห้องประชุม" :modal="true" class="p-fluid">
                <div class="mt-4 mb-4">
                    <img src="/storage/picture/no_image.jpg" :alt="meetingRoom.image" class="meetingRoom-image" v-if="meetingRoom.image"/>
...
export default {
    setup() {
        ...
        //     fullname: meetingRoom.value.fullname,
        //     shortname: meetingRoom.shortname,
        //     building_id: meetingRoom.building_id,
        //     floor: meetingRoom.floor,
        //     status: meetingRoom.status,
        //     capacity_normal: meetingRoom.capacity_normal,
        //     capacity_min: meetingRoom.capacity_min,
        //     capacity_max: meetingRoom.capacity_max,
        //     price_half_day: meetingRoom.price_half_day,
        //     price_full_day: meetingRoom.price_full_day,
        ...
        const saveMeetingRoom = () => {
            ...
            if(! meetingRoom.value.fullname ) {
                ...
                if(meetingRoom.value.id) {
                    ...
                    mRoomForm.post(route('add_meeting_room'), {
                        replace: true,
                        onBefore: () => {
